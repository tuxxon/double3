package com.touchizen.double3.snapshot;
...
public class SnapshotManager {
    ...
    private static final String FILE_NAME = "Double3";
    // TODO: Move this to a resource.
    private static final String FILE_DESCRIPTION = "Double3 highscore save.";
