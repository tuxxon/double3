...
public class MainView extends View {
    ...
    private static int getIndexFromValue(int v) {
        int index = 0;
        switch (v) {
            case 1: return 0;
            case 2: return 1;
            default: index = log2(v/3) + 2;
        }
        return index;
    }
    ...
    private void drawNewGameButton(Canvas canvas, boolean lightUp) {
        ...
        drawDrawable(canvas,
                getResources().getDrawable(R.drawable.ic_baseline_sync_48),
    ...
    private void drawUndoButton(Canvas canvas) {
        ...
        drawDrawable(canvas,
                getResources().getDrawable(R.drawable.ic_baseline_undo_48),
    ...
    private void drawShareButton(Canvas canvas) {
        ...
        drawDrawable(canvas,
                getResources().getDrawable(R.drawable.ic_baseline_share_48),
    ...
    private void drawScreenShareButton(Canvas canvas) {

        drawDrawable(canvas,
                backgroundRectangle,
                sXScreenShare,
                sYIcons, sXScreenShare + iconSize,
                sYIcons + iconSize
        );

        drawDrawable(canvas,
                getResources().getDrawable(R.drawable.ic_baseline_mobile_screen_share_48),
                sXScreenShare + iconPaddingSize,
                sYIcons + iconPaddingSize,
                sXScreenShare + iconSize - iconPaddingSize,
                sYIcons + iconSize - iconPaddingSize
        );
    }
    ...
    private void createBitmapCells() {
        ...
        for (int xx = 0; xx < bitmapCell.length; xx++) {
            ...
            switch (xx) {
                ...
                default: value = 3 * (int) Math.pow(2,xx-2);
            }
